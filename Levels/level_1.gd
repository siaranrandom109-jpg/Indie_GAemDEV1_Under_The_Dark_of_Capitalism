...
func set_player_movement(bisa_gerak: bool) -> void:
	var karakter_aktif = karakter_kaos if is_instance_valid(karakter_kaos) else karakter_hoodie
	if is_instance_valid(karakter_aktif):
		karakter_aktif.set_physics_process(bisa_gerak)
...
# ====================================================================
# ====================================================================
# 🛠️ TOMBOL SAKTI UNTUK TESTING INSTAN ZONA 4 (VERSI FIX PARALLAX)
# ====================================================================
func _unhandled_input(event: InputEvent) -> void:
	if event is InputEventKey and event.pressed and event.keycode == KEY_T:
		...
		if group_parallax_4:
			group_parallax_4.visible = true # <-- MEMAKSA BACKGROUND PARALLAX NYALA UTK TESTING!
